...
$(document).ready(function()
{
	...
	*/
	...
	{
		if($('.desti_slider').length)
		{
			var destiSlider = $('.desti_slider');

			destiSlider.owlCarousel(
			{
				loop:true,
				nav:false,
				dots:false,
			...
			/* Custom nav events */
			if($('.desti_slider_prev').length)
			{
				var prev = $('.desti_slider_prev');

				prev.on('click', function()
				{
					destiSlider.trigger('prev.owl.carousel');
				});
			}

			if($('.desti_slider_next').length)
			{
				var next = $('.desti_slider_next');

				next.on('click', function()
				{
					destiSlider.trigger('next.owl.carousel');
				});
			}
		}
	}
